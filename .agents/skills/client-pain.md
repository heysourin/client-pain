...
## CRITICAL RULE: Real Live Search URLs Only
...
Save the structured results to `agents/utils/_temp_client_pain.json` (ensuring all `source_url` values are verified live search URLs):
  ...
  "leads": [
    {
      ...
      "platform": "Reddit",
      "source_url": "https://www.reddit.com/r/freelance/comments/1i89abc/looking_for_developer/",
